    ...
    *,
    ...
    for epoch in range(1, epochs + 1):
        ...
        if validation_loss < best_loss:
            ...
            checkpoint = {"state_dict": best_state, "model_sha256": hash_state_dict_contents(best_state), "labels": labels, "input_channels": input_channels, "sample_length": sample_length or frames.shape[2], "features": features, "dataset": str(data_path), "seed": seed, "best_epoch": epoch, "best_validation_loss": best_loss}
    ...
    metrics = {
        "model_sha256": hash_state_dict_contents(best_state), "samples": int(len(targets)), "classes": labels, "epochs_completed": completed_epochs, "device": str(selected_device), "dataset": str(data_path), "sample_length": int(sample_length or frames.shape[2]), "features": features, "seed": seed, "best_validation_loss": best_loss,
